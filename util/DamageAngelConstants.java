...
public final class DamageAngelConstants {
    ...
    private static final float BONUS_DAMAGE_KNIGHT = 0.15f;
    private static final float BONUS_DAMAGE_PYROMANCER = 0.2f;
    private static final float BONUS_DAMAGE_ROGUE = 0.3f;
    ...
    private static final float BONUS_DAMAGE_WIZARD = 0.4f;
}
